    ...
    <>
      <div className="welcome_wrap">
        <div data-aos="fade-up" className="welcome1">
          ...
          <img className="angle_down" src="/images/down.png" width="20px" />
        </div>
        ...
        <section data-aos="fade-up" className="div_box">
          ...
          <div data-aos="fade-up">
            <h1>편리한 회원관리</h1>
            <p>
              회원관리 기능을 통해 회원들의 정보 수정 등을 관리할 수 있습니다. <br />
              회원들과의 소통을 원활하게 유지하고 <br />
              회원들의 활동을 모니터링하여 필요한 조치를 취할 수 있습니다.
            </p>
          </div>
        </section>
        <section data-aos="fade-up" className="div_box">
          ...
          <div data-aos="fade-up">
            ...
            <p>
              ...
              강사들의 일정을 조율하여 수업을 효율적으로 운영하고 회원들에게 최상의 강의를 제공할 수
              있습니다.
            </p>
          </div>
        </section>
        ...
        <section data-aos="fade-up" className="div_box">
          ...
          <div data-aos="fade-up">
            <h1>꼼꼼하게 수업관리하기!</h1>
            <p>
              수업관리 기능을 통해 다양한 수업을 제공하고 관리할 수 있습니다. <br />
              수업의 종류, 시간, 장소 등을 등록하고 회원들이 수업을 예약할 수 있도록 합니다. <br />
